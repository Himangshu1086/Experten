...
function Container__For__Category() {
    ...
    return (
        ...
        <div  className=" container  grid grid-cols-6 gap-x-1 gap-y-1 sm:gap-x-5 sm:gap-y-5 ">
            ...
            <Link to="/category/teacher"><div  className="relative z-30 h-96 object-fit w-full   sm:text-3xl text-white font-black"><h1 id="heading-category" className=" w-auto pb-2 ml-3 sm:mx-10 pt-80">Teacher</h1></div></Link>
            ...
            <Link to="/category/electrician"><div  className="relative z-30 h-96 object-fit w-full  sm:text-3xl text-white font-black"><h1 id="heading-category" className=" w-auto pb-2 ml-3 sm:mx-10 pt-80">Electrician</h1></div></Link>
            ...
            <Link to="/category/plumber"><div  className="relative z-30 h-96 object-fit w-full   sm:text-3xl text-white font-black"><h1 id="heading-category" className=" w-auto pb-2 ml-3 sm:mx-10 pt-80">Plumber</h1></div></Link>
            ...
            <Link to="/category/photographer"><div  className="relative z-30 h-96 object-fit w-full sm:text-3xl text-white font-black"><h1 id="heading-category" className=" w-auto pb-2 ml-3 sm:mx-10 pt-80">Photographer</h1></div></Link>
            ...
            <Link to="/category/wallPainter"><div  className="relative z-30 h-96 object-fit w-full  sm:text-3xl text-white font-black"><h1 id="heading-category" className=" w-auto pb-2 ml-3 sm:mx-10 pt-80">Wall Painter</h1></div></Link>
            ...
            <Link to="/category/rajMistri"><div  className="relative z-30 h-96 object-fit w-full  sm:text-3xl text-white font-black"><h1 id="heading-category" className=" w-auto pb-2 ml-3 sm:mx-10 pt-80">Raj Mistri</h1></div></Link>
